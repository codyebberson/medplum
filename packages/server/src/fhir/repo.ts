...
import { Conjunction, Disjunction, InsertQuery, Operator, SelectQuery } from './sql';
...
export class Repository {
  ...
  #addSearchFilter(
    ...
    if (param.type === 'string') {
      ...
      this.#addTokenSearchFilter(predicate, details, filter.value);
   ...
   * @param filter The search filter.
   */
  #addTokenSearchFilter(predicate: Conjunction, details: SearchParameterDetails, query: string): void {
